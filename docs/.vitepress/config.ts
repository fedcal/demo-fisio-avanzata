...
const SLUG = 'fisio-avanzata';
const TITLE = 'Demo Centro Fisioterapia Avanzata — Federico Calò';

export default defineConfig({
  title: TITLE,
  description: 'Documentazione tecnica del template Angular 21 SSR per Centro Fisioterapia Avanzata.',
  base: `/federico-demo-${SLUG}/`,
  cleanUrls: true,
  lang: 'it-IT',

  themeConfig: {
    siteTitle: 'Demo Centro Fisioterapia Avanzata',
