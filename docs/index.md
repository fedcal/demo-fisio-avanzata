...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/demo-fisio-avanzata
...
```bash
git clone https://github.com/fedcal/demo-fisio-avanzata.git
cd demo-fisio-avanzata
npm install
npm start
# → http://localhost:4200
```
...
- [GitHub repo](https://github.com/fedcal/demo-fisio-avanzata)
