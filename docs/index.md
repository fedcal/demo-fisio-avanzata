...
hero:
  name: "Demo Centro Fisioterapia Avanzata"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://fisio-avanzata.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-fisio-avanzata
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Centro Fisioterapia Avanzata.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Centro Fisioterapia Avanzata** in Italia.
...
Il mercato italiano delle PMI per **Centro Fisioterapia Avanzata** ha caratteristiche specifiche:
...
```bash
git clone https://github.com/fedcal/federico-demo-fisio-avanzata.git
cd federico-demo-fisio-avanzata
npm install
npm start
# → http://localhost:4200
```
...
```bash
npm run build
npm run serve:ssr:fisio-avanzata
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-fisio-avanzata)
