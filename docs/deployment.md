...
URL: `https://fisio-avanzata.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `fisio-avanzata.demo.federicocalo.dev`
...
- Output directory: `dist/fisio-avanzata/browser`
...
URL: `https://fedcal.github.io/federico-demo-fisio-avanzata/`
...
- `base: /federico-demo-fisio-avanzata/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `fisio-avanzata-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   fisio-avanzata-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `fisio-avanzata-docs.federicocalo.dev`
